...
class Calculations:
    ...
    def calculate(equation : str):
        ...
        done_equation = Calculations.__addition_and_subtraction(Calculations.__multiplication_and_division(Calculations.__power(Calculations.__factorial(Calculations.__brackets(simplified_equation)))))
    ...
    @staticmethod
    def __factorial(equation : list):
        new_equation = []
        skip = False
        for idx, i in enumerate(equation):
            if i == '!':
                number = 1
                j = int(new_equation.pop())
                for h in range(2, j+1):
                    number *= h
                new_equation.append(str(number))
            else:
                new_equation.append(i)
        ...
        for idx, i in enumerate(equation):
            ...
            if start_idx == None:
                ...
                if i == ")":
                    ...
                    #Calculate the list
                    calculation_list = Calculations.__addition_and_subtraction(Calculations.__multiplication_and_division(Calculations.__power(Calculations.__factorial(calculation_list))))
